<x-layouts.app>
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        ...
        <div>
            ...
            <div
                class="relative flex flex-col w-full h-full overflow-scroll text-gray-700 bg-white dark:bg-neutral-800 shadow-md rounded-lg bg-clip-border">
                <table class="w-full text-left table-auto min-w-max">
                    <thead>
                        <tr class="border-b border-slate-300 bg-slate-50 dark:bg-neutral-900">
