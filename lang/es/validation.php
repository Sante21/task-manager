...
return [
    ...
    */
    ...
    'ascii' => 'El campo :attribute solo debe contener caracteres alfanuméricos y símbolos.',
    ...
    | convención "attribute.rule" para nombrar las líneas. Esto permite especificar rápidamente
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de lenguaje se utilizan para cambiar nuestro placeholder de atributo
    | por algo más fácil de leer, como "Dirección de correo electrónico" en lugar de
    | "email". Esto simplemente nos ayuda a hacer que nuestro mensaje sea más expresivo.
    |
    */
